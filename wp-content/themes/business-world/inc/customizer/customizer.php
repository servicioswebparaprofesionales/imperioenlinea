...
function wdwt_customizer_add_panels($wp_customize ){
  ...
  */
  ...
  $general_main_priority = $wp_customize->get_section( 'general_main' )->priority;
  $core_sections = array('title_tagline','header_image','background_image','static_front_page');
  $core_sections_priority = $general_main_priority+1;
...
function wdwt_customizer_add_scripts(){
  ...
  wp_localize_script( 'wdwt_customizer-preview', 'wdwt_slide_warning', __("You cannot delete the last slide! Try to turn off the slider", "business-world") );
