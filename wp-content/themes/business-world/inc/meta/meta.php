...
function wdwt_meta_init(){
  ...
  $wdwt_post_meta = new Business_world_meta();  
}


require_once('WDWT_meta.php');

class Business_world_meta extends WDWT_meta{
  ...
  public function __construct(){
    ...
    wp_localize_script( WDWT_VAR.'_admin_element_view_script', 'wdwt_slide_warning', __("You cannot delete the last slide! Try to turn off the slider", "business-world") );
    ...
    $layout = new Business_world_meta_layout_controller();
