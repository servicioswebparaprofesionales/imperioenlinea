...
function wdwt_register_required_plugins() {
	...
	$config = array(
		...
		'strings'      => array(
			'page_title'                      => __( 'Install Recommended Plugins', "business-world" ),
			'menu_title'                      => __( 'Recommended Plugins', "business-world" ),
			'installing'                      => __( 'Installing Plugin: %s', "business-world" ), // %s = plugin name.
			...
			'activate'                        => __( 'Activate', "business-world" ),
			...
			'plugin_already_active'           => __( 'No action taken. Plugin %1$s was already active.', "business-world" ),  // %1$s = plugin name(s).
			'plugin_needs_higher_version'     => __( 'Plugin not activated. A higher version of %s is needed for this theme. Please update the plugin.', "business-world" ),  // %1$s = plugin name(s).
			'complete'                        => __( 'All plugins installed and activated successfully. %1$s', "business-world" ), // %s = dashboard link.
