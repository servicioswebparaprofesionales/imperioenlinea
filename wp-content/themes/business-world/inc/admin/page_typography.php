	...
	function __construct(){
		...
		$this->options = array(
			...
			'text_headers_font' => array(
				...
				'title' => __( 'Select Font', "business-world" ),
				'description' => __( 'Fonts with * are not loaded from Google, they will be displayed only if visitor\'s device has them installed.', "business-world" ),
				'type' => 'select_style',
			...
			'text_headers' => array(
				'name' => 'text_headers',
				'title' => __( 'Preview', "business-world" ),
				'type' => 'text_preview',
				'section' => 'text_headers',
				'tab' => 'typography',
				'default' => ''
			...
			'text_headers_button' => array(
				...
				'title' => __( 'Edit font styling', "business-world" ),
				'type' => 'button',
				'show' => array(
					'text_headers_kern',
			...
			'text_headers_kern' => array(
				...
				'title' => __( 'Letter Spacing', "business-world" ),
				'type' => 'select_style',
			...
			'text_headers_transform' => array(
				...
				'title' => __( 'Text Transform', "business-world" ),
				'type' => 'select_style',
			...
			'text_headers_variant' => array(
				...
				'title' => __( 'Variant', "business-world" ),
				'type' => 'select_style',
			...
			'text_headers_weight' => array(
				...
				'title' => __( 'Weight', "business-world" ),
				'type' => 'select_style',
