...
var wdwt_elements = {
  ...
  refresh_colorpanel : function(element){
    ...
    for (color in element.colors[active]) {
      ...
      jQuery("#default_"+element.cpanel+"_"+colorname).attr("value", def);
      jQuery("#value_"+element.cpanel+"_"+colorname).attr("data-default-color",def);

      jQuery("#value_"+element.cpanel+"_"+colorname).attr("value", val);
